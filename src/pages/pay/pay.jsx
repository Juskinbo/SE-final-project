        ...
        >
          ...
          {this.params?.type && (
            <View style={{ margin: '10px 20px' }}>
              <Cell
                title={<span style={{ fontWeight: '500' }}>电影票改签</span>}
                extra={
                  <span style={{ whiteSpace: 'nowrap', marginRight: '5px' }}>
                    手续费0元/张<i style={{ color: 'red' }}>¥0</i>
                  </span>
                }
                description={
                  <>
                    ...
                    >
                      <span style={{ whiteSpace: 'nowrap' }}>
                        1.改签成功后，新电影票不再支持申请改签、退票
                      </span>
                      <span style={{ whiteSpace: 'nowrap' }}>
                        2.影院故障时可能导致改签失败，此时原电影票会自动退款
                      </span>
                    </View>
                    <Divider
                      style={{
